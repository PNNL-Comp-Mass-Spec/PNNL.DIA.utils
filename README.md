...
1.  A set of functions to analyze DIA-NN and Spectronaut outputs and
    convert them to `MSnSet` objects for downstream analysis with
...
GitHub](https://github.com/PNNL-Comp-Mass-Spec/PNNL.DIA.utils) with:
...
*Spectronaut* suggest converting LC-MS files to it’s proprietary
...
Note to run this function you need to have a local version of
[Spectronaut’s *HTRMS
Converter*](https://biognosys.com/resources/spectronaut-tutorial-how-to-speed-up-your-spectronaut-analysis-with-htrms-conversion/).
